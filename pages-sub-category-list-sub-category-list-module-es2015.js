...
function SubCategoryListPage_empty_view_11_Template(rf, ctx) { if (rf & 1) {
...
function SubCategoryListPage_empty_view_12_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](0, "empty-view", 10);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵpipe"](1, "translate");
} if (rf & 2) {
...
const _c1 = function (a0) { return { subcat: a0 }; };
function SubCategoryListPage_ion_row_13_ion_col_7_Template(rf, ctx) { if (rf & 1) {
    ...
    const category_r162 = ctx.$implicit;
...
const _c2 = function (a0) { return { cat: a0 }; };
function SubCategoryListPage_ion_row_13_Template(rf, ctx) { if (rf & 1) {
...
const _c3 = function () { return { width: "60px", height: "60px" }; };
function SubCategoryListPage_section_14_ion_col_2_Template(rf, ctx) { if (rf & 1) {
...
function SubCategoryListPage_section_14_Template(rf, ctx) { if (rf & 1) {
...
class SubCategoryListPage extends _base_page_base_page__WEBPACK_IMPORTED_MODULE_2__["BasePage"] {
    constructor(injector, subCategoryService) {
        super(injector);
...
SubCategoryListPage.ɵfac = function SubCategoryListPage_Factory(t) { return new (t || SubCategoryListPage)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injector"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_services_sub_category__WEBPACK_IMPORTED_MODULE_3__["SubCategory"])); };
SubCategoryListPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: SubCategoryListPage, selectors: [["page-sub-category-list"]], viewQuery: function SubCategoryListPage_Query(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ionRefresh", function SubCategoryListPage_Template_ion_refresher_ionRefresh_6_listener($event) { return ctx.loadData($event); });
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](SubCategoryListPage, [{
    ...
    }], function () { return [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Injector"] }, { type: _services_sub_category__WEBPACK_IMPORTED_MODULE_3__["SubCategory"] }]; }, { container: [{
