...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-address-list-address-list-module"], {
  ...
  function srcAppPagesAddressListAddressListTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function AddressListPage_empty_view_15_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function AddressListPage_ion_row_17_ion_item_3_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function AddressListPage_ion_row_17_ion_item_3_Template_ion_button_click_13_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r369);

          var address_r367 = ctx.$implicit;

          var ctx_r368 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](2);

          return ctx_r368.onDeleteAddress(address_r367);
        });
    ...
    function AddressListPage_ion_row_17_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function (_base_page_base_page_) {
      ...
      function AddressListPage(injector, customerAddressService) {
        ...
        _this = _possibleConstructorReturn(this, _getPrototypeOf(AddressListPage).call(this, injector));
                ...
                switch (_context3.prev = _context3.next) {
                  ...
                  case 13:
                    ...
                    this.translate.get('DELETED').subscribe(function (str) {
                      return _this3.showToast("Direccion eliminada");
                    });
                    _context3.next = 23;
                    break;
    ...
    AddressListPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
      ...
      template: function AddressListPage_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function AddressListPage_Template_ion_button_click_9_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ionRefresh", function AddressListPage_Template_ion_refresher_ionRefresh_12_listener($event) {
