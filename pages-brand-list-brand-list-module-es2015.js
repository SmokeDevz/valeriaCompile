...
function BrandListPage_div_13_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div", 13);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](1, "ion-spinner");
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
} }
function BrandListPage_empty_view_14_Template(rf, ctx) { if (rf & 1) {
...
function BrandListPage_empty_view_15_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](0, "empty-view", 14);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵpipe"](1, "translate");
} if (rf & 2) {
...
function BrandListPage_ion_row_16_ion_col_1_Template(rf, ctx) { if (rf & 1) {
...
function BrandListPage_ion_row_16_Template(rf, ctx) { if (rf & 1) {
...
class BrandListPage extends _base_page_base_page__WEBPACK_IMPORTED_MODULE_2__["BasePage"] {
    constructor(injector, brandService) {
        super(injector);
...
BrandListPage.ɵfac = function BrandListPage_Factory(t) { return new (t || BrandListPage)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injector"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](src_app_services_brand__WEBPACK_IMPORTED_MODULE_3__["Brand"])); };
BrandListPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: BrandListPage, selectors: [["app-brand-list"]], viewQuery: function BrandListPage_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, features: [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵInheritDefinitionFeature"]], decls: 17, vars: 4, consts: [[1, "ion-no-border"], ["fixed", ""], ["slot", "start"], ["text", ""], [1, "show-sm-up", 2, "display", "flex", "flex-direction", "column", "padding-bottom", "8px"], [1, "logo", 2, "display", "flex"], ["scrollEvents", "true"], ["container", ""], ["slot", "fixed", 3, "ionRefresh"], ["pullingText", "Desliza para actualizar", "refreshingText", "Actualizando"], ["class", "ion-text-center", 4, "ngIf"], ["icon", "alert-circle-outline", 3, "text", 4, "ngIf"], [4, "ngIf"], [1, "ion-text-center"], ["icon", "alert-circle-outline", 3, "text"], ["size-xs", "4", "size-md", "3", "class", "ion-text-center", 4, "ngFor", "ngForOf", "ngForTrackBy"], ["size-xs", "4", "size-md", "3", 1, "ion-text-center"], [3, "routerLink", "queryParams"], ["defaultImage", "./assets/imgs/placeholder.png", 1, "bg-img", 3, "customObservable", "lazyLoad"], [1, "link", "ellipsis"]], template: function BrandListPage_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ionRefresh", function BrandListPage_Template_ion_refresher_ionRefresh_10_listener($event) { return ctx.loadData($event); });
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](BrandListPage, [{
    ...
    }], function () { return [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Injector"] }, { type: src_app_services_brand__WEBPACK_IMPORTED_MODULE_3__["Brand"] }]; }, { container: [{
