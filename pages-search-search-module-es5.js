...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-search-search-module"], {
  ...
  function srcAppPagesSearchSearchTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function SearchPage_ion_buttons_7_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function SearchPage_ion_buttons_7_Template_ion_button_click_1_listener() {
    ...
    function SearchPage_empty_view_15_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function SearchPage_ion_list_16_ion_col_2_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function SearchPage_ion_list_16_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function SearchPage_ion_row_17_ion_col_1_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "ion-col", 17);
    ...
    function SearchPage_ion_row_17_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function (_base_page_base_page_) {
      ...
      function SearchPage(injector, itemService) {
        ...
        _this = _possibleConstructorReturn(this, _getPrototypeOf(SearchPage).call(this, injector));
    ...
    SearchPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
      ...
      template: function SearchPage_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("keyup", function SearchPage_Template_ion_searchbar_keyup_5_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ionRefresh", function SearchPage_Template_ion_refresher_ionRefresh_9_listener($event) {
